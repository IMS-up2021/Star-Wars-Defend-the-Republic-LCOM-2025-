...
bool init_enemies(void) {
    ...
    if (!e1_sprite_data) printf("Failed to load e1 sprite\n");
    if (!e2_sprite_data) printf("Failed to load e2 sprite\n");
    if (!e3_sprite_data) printf("Failed to load e3 sprite\n");
    ...
    if (!a1_sprite_data) printf("Failed to load a1 attack sprite\n");
    if (!a2_sprite_data) printf("Failed to load a2 attack sprite\n");
    if (!a3_sprite_data) printf("Failed to load a3 attack sprite\n");
