...
xpm_image_t selected1, selected2, selected3;

void load_characters1_assets(){
    sel1 = xpm_load(selected1_xpm, XPM_5_6_5, &selected1);
}

void draw_characters1(){
    vg_draw_scaled_pixmap(sel1, selected1.width, selected1.height, 2, 0, 0, mode_info.XResolution, mode_info.YResolution);
}
