...
bool init_player_units(void) {
    ...
    ah1_sprite_data = xpm_load(attack_1, XPM_5_6_5, &ah1_img);
    ...
    if (!ah1_sprite_data) printf("Failed to load Player Char 1 attack sprite\n");
    if (!ah2_sprite_data) printf("Failed to load Player Char 2 attack sprite\n");
    if (!ah3_sprite_data) printf("Failed to load Player Char 3 attack sprite\n");
